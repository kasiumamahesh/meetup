							...
							<div class="col-lg-6 col-md-12 col-sm-12">
								...
								<div class="breadcrumb-list">
									<ul>
                                        ...
                                        <li class="breadcrumb-item"><a href="event.php" class="breadcrumb-link">Event listing</a></li>
                                        <li class="breadcrumb-item"><a href="event-details.php" class="breadcrumb-link">Event Details</a></li>
											...
											<form action="#">
												...
												<div class="expired-date-form">
													...
													<ul>
														...
														<li>
															<div class="form-item">
																<input type="text" placeholder="IFC">
															</div>
														</li>
						...
						<div class="sidebar-section">
							...
							<div class="location-wrapper bg-white">
								...
								<div class="location-info-list ul-li-block clearfix">
									<ul>
										<li><i class="fas fa-arrow-circle-right"></i> 100 ft road, near cyber towers, hyderabad, telangana </li>
