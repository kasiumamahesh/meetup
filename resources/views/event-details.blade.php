							...
							<div class="col-lg-6 col-md-12 col-sm-12">
								...
								<div class="breadcrumb-list">
									<ul>
                                        ...
                                        <li class="breadcrumb-item"><a href="event-listing.php" class="breadcrumb-link">Event listing</a></li>
										<li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Event Details</a></li>
									</ul>
								</div>
								<!-- breadcrumb-list - end -->
					...
					<div class="col-lg-8 col-md-12 col-sm-12">
						...
						<div class="event-details mb-80">
							...
							<div class="event-title mb-30">
								<h2 class="event-title">Mumbai <strong>Food Truck Festival 2018</strong></h2>
							</div>
						...
						<div class="register-wrapper mb-80 clearfix">
							...
							<div class="register-table">
								<ul>
									<li class="rt-header">
										<div class="header-leftside-content">SUN, <strong>DEC 26, 2018,</strong> 15:00 PM – 17:00 PM</div>
										<div class="header-rightside-content">Sales end on December 23</div>
									</li>
									<li class="rt-body">
										<div class="rt-body-item">
											<div class="leftside-content">
												<h3 class="ticket-title">Ticket Price</h3>
												<span class="ticket-price">RS. 12000.00 + GST 5%</span>
											</div>
									...
									<li class="rt-footer">
										<div class="footer-leftside-content">
											...
											<span class="total-price">TOTAL PRICE :  Rs. 12600.00</span>
										</div>
										<div class="footer-rightside-content">
											<a href="event-booking.php" class="custom-btn">register now</a>
										</div>
									</li>
								</ul>
							</div>
						...
						<div class="reviewer-comment-wrapper mb-80 clearfix">
						...
						<div class="comment-form clearfix">
							...
							<div class="form-wrapper">
								<form action="http://jthemes.org/html/harmony-event/contact.php">
									<div class="row">
										...
										<div class="col-lg-12 col-md-12 col-sm-12">
											...
											<button type="submit" class="custom-btn">Comment</button>
										</div>
										<!-- form-item - end -->
						...
						<div class="sidebar-section">
							...
							<div class="location-wrapper mb-30">
								...
								<div class="location-info-list ul-li-block clearfix">
									<ul>
										<li><i class="fas fa-arrow-circle-right"></i> 100 feet road, near cyber towers, hyderabad.</li>
