		...
		<section id="faq-section" class="faq-section sec-ptb-100 clearfix">
			<div class="container">
				...
				<div class="section-title mb-50">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
							<h2 class="big-title">2. about <strong>events</strong></h2>
						</div>
					</div>
				</div>
				<!-- section-title - end -->
				...
				<div class="section-title mb-50">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
							<h2 class="big-title">3. about <strong>groups</strong></h2>
						</div>
					</div>
				</div>
				<!-- section-title - end -->
				...
				<div class="section-title mb-50">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
							<h2 class="big-title">4. about <strong>categories</strong></h2>
						</div>
					</div>
				</div>
				<!-- section-title - end -->
