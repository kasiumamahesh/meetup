...
<section id="" class="report-reason sec-ptb-100 clearfix">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <form id="report-reason-form" action="" method="" class="report-reason-form">
                    <ul>
                        <li>
                            <input type="radio" name="report"/>Intellectual property infringement
                        </li>
                        <li>
                ...
                <a href="report-group-final.php"><button class="report-reason-next">Next</button></a>
            </div>
        </div>
    </div>
</section>
