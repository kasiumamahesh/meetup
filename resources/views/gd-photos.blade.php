                        ...
                        <div class="gd-tabs-list">
                            ...
                            <div class="schedule-wrapper">
                                <ul class="nav schedule-date-menu">
                                    ...
                                    <li><a class="active" data-toggle="tab" href="#photos">Photos</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tab-content">
                            <!-- photos - start -->
                            <div id="photos" class="tab-pane fade in active show">

                                <!-- gallery-section - start -->
                                <section id="event-gallery-section" class="event-gallery-section clearfix">
                                    <div class="container">
