                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tab-content">
                            <!-- about - start -->
                            <div id="about" class="gd-about-tabs tab-pane fade in active show">
                                <section id="event-details-section" class="event-details-section sec-ptb-10 clearfix">
                                    <div class="container">
                                        <div class="row">
                                            <!-- col - event-details - start -->
                                            <div class="col-lg-8 col-md-12 col-sm-12">
                                                ...
                                                <div class="event-details mb-80">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>Consequatur voluptatem soluta accusamus ab.</li>
                                                        <li>Eius distinctio ratione sit dignissimos!</li>
                                                ...
                                                <div class="sidebar-section">
                                                    ...
                                                    <div class="spacial-event-wrapper text-center" style="background-image: url(assets/images/spacial-event-bg.jpg);">
                                                        <div class="overlay-black">
                                                            ...
                                                            <a href="event-details.php" class="custom-btn">Details</a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="spacial-event-wrapper text-center" style="background-image: url(assets/images/spacial-event-bg.jpg);">
                                                        <div class="overlay-black">
                                                            <p class="sub-title white-color mb-30">26 DECEMBER 2018</p>
                                                            <h2 class="title-large white-color mb-30">
                                                                <strong class="yellow-color">iOS CONFERENCE</strong>
                                                            </h2>
                                                            <a href="event-details.php" class="custom-btn">Details</a>
                                                        </div>
                                                    </div>
